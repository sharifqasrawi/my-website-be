...
namespace My_Website_BE.Migrations
{
    ...
    [Migration("20200703085800_addedproject3")]
    partial class addedproject3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("My_Website_BE.Models.Project", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("VideoDemoUrlExt")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("My_Website_BE.Models.ProjectTag", b =>
                {
            ...
            modelBuilder.Entity("My_Website_BE.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("My_Website_BE.Models.ProjectTag", b =>
                {
                    b.HasOne("My_Website_BE.Models.Project", "Project")
                        .WithMany("ProjectTags")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("My_Website_BE.Models.Tag", "Tag")
                        .WithMany("ProjectTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
